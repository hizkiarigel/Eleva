...
## Onboarding & Pathway (adaptif, v4.3)

Onboarding: **Nama + Privacy Promise** (satu layar, checkbox konfirmasi) → **Radar self-assessment** (8 sumbu — Body, Mind, Career, Finance, Emotional Stability, Explorer, Social, Purpose — drag titik sudut, skala 1-10, default 5, total SELALU tepat 40; redistribusinya berbasis **evidence sinergi antar-sumbu** (`SYNERGY` matrix di `public/app.js`, 15 pasangan ber-bukti riset): menggeser satu sumbu ikut menarik partner ber-evidence-nya secara terbobot — searah atau berlawanan — dan sisanya menyerap proporsional, dengan constraint-solving yang menskalakan seluruh gerakan kalau ada titik mau keluar 1-10, plus feedback getar+teks saat mentok; konsekuensi disengaja: Career sendirian maksimal ≈8, tidak pernah bisa 10, karena punya keterkaitan riset ke hampir semua sumbu lain; angka nilai tampil di tiap titik, dan tap titik = kunci/buka — maksimal 3 titik terkunci yang tidak ikut bergeser oleh redistribusi, jadi kombinasi ekstrem kayak dua sumbu 10 sekaligus mungkin kalau dua-duanya dikunci; info kunci jadi konteks buat AI, bukan rumus makna tetap di kode; **v4.3**: sumbu yang sudah persis di floor/ceiling — sisa dari drag sebelumnya — dikecualikan dari constraint-solving alih-alih menolak seluruh gesekan berikutnya; sebelumnya satu sumbu mentok bisa membekukan drag sumbu lain sama sekali walau sumbu itu masih punya ruang gerak, lihat riwayat v4.3 di `PRD.md` bagian 9) → **Adaptive Statement Cards** (4-10 kartu: AI generate satu pernyataan orang-pertama per kartu — kartu pertama dari pola radar, berikutnya dari radar + histori swipe — dan pengguna cukup thumbs up "ini aku" / thumbs down "bukan aku", tanpa mengetik; AI berhenti sendiri begitu pola swipe cukup konsisten; pernyataan di-generate per pengguna, bukan bank pernyataan statis — menggantikan pertanyaan statis Situasi/Values/Fear yang dulu ada) → **Chapter Analysis** (insight naratif AI + rekomendasi Pathway dari 6 arah: Builder, Guardian, Explorer, Connector, Seeker, Specialist — plus Secondary Trait opsional, informasional saja) → konfirmasi: terima rekomendasi AI ("Mulai First Trial") ATAU override manual lewat teks bebas ("Bukan ini — aku tahu persis mau melatih apa").
