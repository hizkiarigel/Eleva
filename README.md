...
reference/
  ...
  ELEVA_Constitution_Product_Bible_v1.5.docx → filosofi produk & changelog keputusan (sumber restrukturisasi 7 elemen MECE)
```
...
## Onboarding & Pathway (adaptif, v7 — lock tension + perbandingan radar visual + Pathway 3-kartu)
