...
## 9. Task 5 — Pathway di onboarding: adaptif, direkomendasikan AI (v6, SELESAI — menggantikan desain v3 di bawah)
...
- [x] Kartu format skenario + TEPAT 4 opsi (BUKAN thumbs up/down satu pernyataan) — dites di browser, tiap kartu selalu punya 4 opsi dari 4 sumbu unlocked berbeda
- [x] Sumbu terkunci TIDAK PERNAH muncul sebagai opsi di kartu manapun — dites eksplisit (lock Autonomy → dites lewat seluruh sesi kalibrasi, tidak pernah ditawarkan)
