...
## 9. Task 5 — Pathway di onboarding: adaptif, direkomendasikan AI (v4.1, SELESAI — menggantikan desain v3 di bawah)
...
**Definition of done Task 5 v4.1 (menggantikan DoD v3/v4):**
- [x] Step 1 (Nama + Privacy Promise) satu layar dengan checkbox, bukan dua step terpisah
- [x] Radar chart 8 sumbu, default 5/5/5..., total SELALU TEPAT 40 (integer-exact, bukan proportional-lalu-round yang drift), perubahan satu sumbu mendistribusi ulang HANYA sumbu lain yang belum terkunci (zero-sum, bukan independen)
