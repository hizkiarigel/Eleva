...
## Corpus Check
- 55 files · ~475,316 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 722 nodes · 1116 edges · 52 communities (43 shown, 9 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 111 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f8e7332b`
...
### Community 1 - "app.js"
Cohesion: 0.03
Nodes (54): adaptiveCards, adaptiveSelection, ARTIFACT_TYPE_LABEL, authForm, authTimers, AXIS_DEFINITIONS, AXIS_LABEL_RULES, BRIDGE_LOADING_SEQUENCE (+46 more)
...
### Community 18 - "esc"
Cohesion: 0.13
Nodes (23): artifactsSheetHTML(), axisDefinitionsHTML(), completedResultCardHTML(), elevaResponseHTML(), esc(), goalCardAccentColor(), goalCardApprovedHTML(), goalCardBorderColor() (+15 more)
...
Cohesion: 0.07
Nodes (32): activeSomaQuest(), appHeaderHTML(), beginStructuredOrReflectiveFlow(), characterScreenHTML(), deriveDoDChecklist(), durasiMenitFromFields(), ensureCountdownTicking(), fileToBase64() (+24 more)
...
### Community 46 - "applyCalibrationCard"
Cohesion: 0.33
...
## Knowledge Gaps
- **228 isolated node(s):** `name`, `version`, `description`, `main`, `type` (+223 more)
